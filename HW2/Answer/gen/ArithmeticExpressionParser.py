    ...
    def factor(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = ArithmeticExpressionParser.Factor_is_integerContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 58
                self._errHandler.sync(self)
                ...
                self.state = 60
                self.match(ArithmeticExpressionParser.INTEGER)
                pass

            elif la_ == 3:
                localctx = ArithmeticExpressionParser.Factor_is_floatContext(self, localctx)
                ...
                self.state = 64
                self.match(ArithmeticExpressionParser.FLOAT)
                pass
