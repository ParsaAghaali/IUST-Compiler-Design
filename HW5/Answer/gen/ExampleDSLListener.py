...
class ExampleDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExampleDSLParser#showhint.
    def enterShowhint(self, ctx:ExampleDSLParser.ShowhintContext):
        pass

    # Exit a parse tree produced by ExampleDSLParser#showhint.
    def exitShowhint(self, ctx:ExampleDSLParser.ShowhintContext):
        pass


    # Enter a parse tree produced by ExampleDSLParser#option.
    def enterOption(self, ctx:ExampleDSLParser.OptionContext):
        pass

    # Exit a parse tree produced by ExampleDSLParser#option.
    def exitOption(self, ctx:ExampleDSLParser.OptionContext):
        pass
