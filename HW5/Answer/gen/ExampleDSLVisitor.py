...
class ExampleDSLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ExampleDSLParser#showhint.
    def visitShowhint(self, ctx:ExampleDSLParser.ShowhintContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ExampleDSLParser#option.
    def visitOption(self, ctx:ExampleDSLParser.OptionContext):
        return self.visitChildren(ctx)
